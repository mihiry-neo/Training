...
# Load environment variables (from .env file or Docker/Airflow env)
load_dotenv()
...
def bronze_ingest(spark, jdbc_url, props, table, bronze_path, processing_date):
    ...
    try:
        ...
        # Construct destination path partitioned by date
...
if __name__ == "__main__":
    ...
    # CLI args
    table_name = sys.argv[1]           # e.g., users
    bronze_path = sys.argv[2]          # e.g., /opt/data_lake/bronze
    processing_date = sys.argv[3]      # e.g., 2025-07-28

    # Load MySQL configs from .env
    ...
    # Run ingestion for the specified table
