...
def delete_product_and_inventory(
    ...
    if product.inventory:
        qty = product.inventory.quantity_available or 0
    ...
    # Step 2: Delete inventory then product
    if product.inventory:
    ...
    return {"message": f"Product ID {product_id} deleted, inventory removed, stock movement recorded."}
